...
if(!$global->set_permission(PERMIT_VIEW,true,$MODULEFOLDER)){
	...
	if($form->GET("img_del")){
		...
		header("Location: inventory-add.html?id=".$id);
		exit;	
	}
	...
	if($photo){
		$photo = '<div class="col-md-4"><img src="./UserFiles/image_thumb/'.$photo.'" /> [ <a href="inventory-add.html?id='.$id.'&img_del=true">Delete</a> ]</div>';	
	}else{
